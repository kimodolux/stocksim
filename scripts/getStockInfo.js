...
var main = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var stocks, x, filePath
    return __generator(this, function (_a) {
      stocks = firebase_1.db.collection("stocks")
      for (x = 1; x <= 5; x++) {
        filePath = path.join(__dirname, "ASX200-" + x + ".txt")
        fs.readFile(filePath, function (err, data) {
          return __awaiter(void 0, void 0, void 0, function () {
            var symbols, options, response, count
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  symbols = data.toString().replace(/\n/g, ".AX,")
                  options = {
                    method: "GET",
                ...
                case 1:
                  ...
                  count = 1
                  try {
                    response.data.quoteResponse.result.forEach(function (s) {
